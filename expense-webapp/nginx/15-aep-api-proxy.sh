...
# Primary sibling address. This is the UPPER_SNAKE `_URL` of the primary
# component-kind dependency (expense-api → EXPENSE_API_URL). OpenChoreo
# injects it on the pod.
